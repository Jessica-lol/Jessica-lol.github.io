    ...
    var v = {
      ...
      g = {
        "zh-cn": {
          ...
          tips: {
            comments: "è¯„è®º",
            sofa: "å¿«æ¥åšç¬¬ä¸€ä¸ªè¯„è®ºçš„äººå§~",
            busy: "è¿˜åœ¨æäº¤ä¸­ï¼Œè¯·ç¨å€™...",
            again: "è¿™ä¹ˆç®€å•ä¹Ÿèƒ½é”™ï¼Œä¹Ÿæ˜¯æ²¡è°äº†."
          },
          ctrl: {
            reply: "å›žå¤",
            ok: "å¥½çš„",
          ...
          error: {
            99: "åˆå§‹åŒ–å¤±è´¥ï¼Œè¯·æ£€æŸ¥initä¸­çš„`el`å…ƒç´ .",
            100: "åˆå§‹åŒ–å¤±è´¥ï¼Œè¯·æ£€æŸ¥ä½ çš„AppIdå’ŒAppKey.",
            401: "æœªç»æŽˆæƒçš„æ“ä½œï¼Œè¯·æ£€æŸ¥ä½ çš„AppIdå’ŒAppKey.",
            403: "è®¿é—®è¢«apiåŸŸåç™½åå•æ‹’ç»ï¼Œè¯·æ£€æŸ¥ä½ çš„å®‰å…¨åŸŸåè®¾ç½®."
          },
          timeago: {
            seconds: "ç§’å‰",
            minutes: "åˆ†é’Ÿå‰",
      ...
      var j = function () {
        ...
        P = function (e) {
          return u.attr(I, "disabled") ? void t.alert.show({
            type: 0,
            text: t.locale.tips.busy + 'ãƒ¾(à¹‘â•¹â—¡â•¹)ï¾‰"',
        ...
        F = function e(n) {
          AV.User.requestPasswordReset(n.mail).then(function (e) {}).catch(function (r) {
            1 == r.code ? t.alert.show({
              type: 0,
              text: "ãƒ¾(ï½ï½¥Ï‰ï½¥)ï¾‰ Atå¤ªé¢‘ç¹å•¦ï¼Œæé†’åŠŸèƒ½æš‚æ—¶å®•æœºã€‚<br>" + r.error,
              ctxt: t.locale.ctrl.ok
            }) : Q(n).then(function (t) {
              e(n)
            }).catch(function (e) {})
